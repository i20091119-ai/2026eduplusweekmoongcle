...
function demoPrint() {{
  ...
  d.write(applyFontUris(`<!DOCTYPE html><html><head><meta charset="utf-8"><style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .sheet {{ position:relative; width:210mm; height:297mm; transform-origin:0 0;
      transform: translateX(210mm) rotate(90deg) scale(0.70710678); }}
    .cut {{ position:absolute; top:148.5mm; left:6mm; right:6mm; border-top:0.6pt dashed #b9b0a2;
      text-align:center; color:#b9b0a2; font-size:7pt; }}
  ...
  </style></head><body><div class="sheet"><div class="page">
  ...
  </div></div><div class="cut"><span>-- 여기를 따라 잘라 주세요 --</span></div></body></html>`));
  d.close();
