...
| 프로그램 | 방식 | 결과 |
|---|---|---|
| 🐾 나를 닮은 동물 찾기 | 성격유형검사 16문항 (7점 척도) | 16유형 → 동물 도안 16종 + 매칭 근거 |
| 🍕 음식 이상형 월드컵 | 16강 토너먼트 | 우승 음식 도안 |
...
| | 게임 | 방식 |
|---|---|---|
| 🧩 | 떡몬스터 짝맞추기 | 카드 12장 기억력 |
| ⚡ | 동물 순발력 테스트 | 반응속도 5회 평균 → 동물 등급 (치타~나무늘보) |
| 💰 | 용돈 일주일 인생게임 | 캐릭터 선택 → 8일 소비 선택 → 정산·등급·마무리 퀴즈 |
| 🥁 | 쿵덕쿵덕 떡메치기 | 게이지 타이밍에 아무 데나 클릭 — 조준 불필요 |
| 🔍 | 다른 몬스터 찾기 | 틀린그림 찾기, 단계 상승 |
| 🧠 | 떡 주문 기억왕 | 주문 순서 외워 4지선다 회상 · 목숨 3개 |
| ⚖️ | 기우뚱 떡시루 | 떡 그램수 조합으로 저울 수평 맞추기 |
